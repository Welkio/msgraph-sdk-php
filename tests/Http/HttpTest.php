...
class HttpTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->getRequest = new GraphRequest("GET", "/endpoint", $this->client);
    }
    ...
    {
        $request = new GraphRequest("POST", "/endpoint", $this->client);
    ...
    {
        $request = new GraphRequest("PUT", "/endpoint", $this->client);
        $response = $request->execute($this->client);
        $code = $response->getStatus();
    ...
    {
        $request = new GraphRequest("PATCH", "/endpoint", $this->client);
        $response = $request->execute($this->client);
        $code = $response->getStatus();
    ...
    {
        $request = new GraphRequest("UPDATE", "/endpoint", $this->client);
        $response = $request->execute($this->client);
        $code = $response->getStatus();
    ...
    {
        $request = new GraphRequest("DELETE", "/endpoint", $this->client);
        $response = $request->execute($this->client);
        $code = $response->getStatus();
    ...
    public function testInvalidVerb()
    {
        ...
        $request = new GraphRequest("OBLITERATE", "/endpoint", $this->client);
